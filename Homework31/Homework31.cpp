...
//Разработать структуру «Живая сущность» состоящую из полей :
//• скорость передвижения;
//• тип(птица, скот, человек);
//• цвет;
//• характеристика(для птицы - скорость полета, вещественное число,
//	для скота — парнокопытное, логическая переменная, для человека
//	— уровень IQ, целая переменная).
//	Рекомендации: характеристику реализовать как объединение, тип
//	реализовать как перечислимый тип данных(enum)
//	Создать экземпляр структуры «Живая сущность» и реализовать для него
//	следующие функции :
//• Ввод информации;
//• Печать информации.
//Создать массив из 10 экземпляров структуры «Живая сущность» и
